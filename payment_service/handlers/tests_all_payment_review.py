...
class TestInvoiceHandler(unittest.TestCase):
    ...
    #########################################___________PAYMENTHANDLER___________________###########################################
    ...
    def test_process_payment_success(self, mock_client, mock_validate_payment):
        ...
        self.assertEqual(len(result.invoice), 1)  
    ...
    #########################################___________INVOICEHANDLER___________________###########################################
...
if __name__ == '__main__':
    with open('./test-reports/payment_service_tests.xml', 'wb') as output:
