...
class User(Model):
    ...
    """
    def __init__(self, username: str=None, address: str=None):  # noqa: E501
    ...
    def username(self) -> str:
        ...
        The username used to refer to the user. Must be unique and contain only alfanumeric characters. No accented characters  # noqa: E501
